...
class BaseSimulator:
    ...
    def reset(self, env_ids=None):
        ...
        # print("[INFO]current_object_pose", current_object_pose)
        # current_object_com = self.object_prim.data.root_com_pos_w[:, :3]
        # print("[INFO]current_object_com", current_object_com)
    ...
    def record_data(self, obs: Dict[str, torch.Tensor]):
        # Use task_step_count instead of count to align with RoboTwin's control_idx-based saving
