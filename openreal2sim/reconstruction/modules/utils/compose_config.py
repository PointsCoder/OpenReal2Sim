...
default_config = {
    ...
    "bg_completion_mode": "hybrid",  # "plane" or "moge"
    ...
    "fast_scene_construction": True,  # whether to use fast (but inaccurate) point cloud registration
    ...
    "fdpose_resize_factor": 0.3,  # foundation pose: resize factor for the image
